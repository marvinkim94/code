...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    turn, result, rolled_one = 0, 0, False
    while turn != num_rolls :
        ...
        if value == 1 :
            ...
            result += value
        turn += 1
    return (rolled_one and 1) or result
    # END PROBLEM 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    while score0 < goal and score0 < 100 and score1 < goal and score1 < 100:
        if player == 0 :
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def say_high(score0, score1):
        if who == 0 :
            we_care_score = score0
        if who == 1 :
            we_care_score = score1
        sub = we_care_score - previous_score
        if sub > previous_high :
            ...
            return announce_highest(who, sub, we_care_score)
        return announce_highest(who, previous_high, we_care_score)
    return say_high
#######################
# Phase 3: Strategies #
#######################
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    maxhigh = 0
    while t < 10 :
        r = make_averaged(roll_dice, num_samples)
        total = r(n, dice)
        if  total > maxaver :
            maxaver = total
            maxhigh = n
